...
public class SensorEventServiceImpl implements SensorEventService {
    ...
    public SensorEventServiceImpl(KafkaProducer<String,
                                      SpecificRecordBase> producer,
    ...
    public void processSensor(SensorEvent event) {
        ...
        String sensorTopic = kafkaProperties.getProperty("kafka.topic.sensor.events");

        ProducerRecord<String, SpecificRecordBase> record =
                new ProducerRecord<>(sensorTopic, event.getId(), sensorEventAvro);
